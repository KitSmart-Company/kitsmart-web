  ...
  return (
    <>
      ...
      >
        ...
        <input
          className="p-4 rounded-2xl w-full pl-11 outline-none"
          type="text"
        ...
        {products.length > 0 && (
          <div
            className={cn(
              "absolute w-full mt-2 bg-white rounded-xl py-2 top-14 shadow-md transition-all duration-200 invisible opacity-0 z-30",
